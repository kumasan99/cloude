...
最終更新: 2026-08-27 12:40 JST

## 1. 体制（誰が・どこで・いつ）

| 名前 | 役割 | 形態 | セッション/定例 |
|---|---|---|---|
| クロ | COO・司令塔（このセッション） | Claude Code常駐 | session_01LBSUnGd772xYALnNMNfupj |
...
|---|---|---|
| trig_019gtuEZkEmvRpiNjHuLC9xF | 巡回便（アルバイト受け渡し検収・ヘルスビート確認） | **2時間おき・偶数時01分UTC**（8/27に毎時→2時間おきへ変更・使用量対策） |
| trig_01L9ULMGWoZmwcKcCN3cM3sy | シルベ・モーニングレポート | 毎朝8:07 JST |
| trig_01Rhv6vptXR5A3XcmorJhVz2 | スズ・18時定例（台帳消込・番台更新・5部報告） | 毎日18:00 JST |
| trig_01PgRYhYgkCmZrXsvRiiZ694 | 連携便（PENDING差分をセバス/アオイへ） | 毎日18:20 JST |
| trig_01BEJbiU…（別env） | リン夜間ジョブ（Mac接続） | 毎朝4:38 JST |
...
- 次の削減カード（未実施）: 深夜帯の巡回停止／アルバイトCowork巡回の間引き（社長操作）／クロセッションの世代交代（履歴リセット）
